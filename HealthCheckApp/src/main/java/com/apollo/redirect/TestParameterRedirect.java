...
@WebServlet("/paramDetails")
public class TestParameterRedirect extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (session == null) {
			...
			sc.getRequestDispatcher("/WEB-INF/testparameterdetails.html").forward(request, response);
		}
